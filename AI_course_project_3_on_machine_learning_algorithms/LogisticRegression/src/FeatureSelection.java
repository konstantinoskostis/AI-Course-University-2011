...
public class FeatureSelection {
	...
	public void selectFeatures(){
		...
		//How many times does a word appear in HAMS
		//How many times does a word appear in all messages
		for(int i=0; i<allWords.size(); i++){ // for every word
		...
		//sort the words based on mutual-information (using bubblesort)
        ...
        FileWriter fw;
		try {
			fw = new FileWriter("Features.txt");
